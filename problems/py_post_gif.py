...
def main(exodus_filename, output_filename):
    ...
    mesh_c2.point_data['c2'] = c2_all[0]  # Set initial data
    mesh_c3.point_data['c3'] = c3_all[0]  # Set initial data
    ...
    for i in tqdm(range(nt), desc="Generating frames"):
        ...
        # Render the current frame and write it to the GIF.
        plotter.write_frame()
    
    # Close the plotter and finalize the GIF.
    plotter.close()

...
[Materials]
    ...
    [mobility1]
        ...
        expression = '(M*exp((15*(1-c1-c2)-3)))*(1-eta)/2'
        block = '0  2'
    []
    [mobility2]
        type = DerivativeParsedMaterial
    ...
    [beta_penalty]
        ...
        expression = 'if(c1>0, if(c2>0, if(1-c1-c2>0, beta*(1/c1 + 1/c2 + 1/(1 - c1 - c2)), 0), 0),
                      0)'
        derivative_order = 2
        block = '0  2'
    []
...
[Outputs]
    [ex]
        type = Exodus
        file_base = output/3p_dis_void_ic
